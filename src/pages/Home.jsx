...
return (
    <>
        ...
        <div className="home-text-container">
            ...
            We build Aurion from the ground up. Performance. Elegance. Aurion.
            From sedans to SUVs and trucks, each model is crafted to define excellence.
        ...
        <div className="current-offers">
            ...
            <a className="offers-button" href="/vehicles">Check Our Vehicles</a>
        </div>
    </>
    );
}
